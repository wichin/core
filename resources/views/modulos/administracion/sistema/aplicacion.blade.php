...
@section('contenido')
                    ...
                    <ul class="nav navbar-right panel_toolbox">
                        <li>
                            <button class="btn btn-success btn-sm" id="btnNewElement">
                                <i class="fa fa-cog"></i> &nbsp;NUEVA APLICACIÓN
                            </button>
                        </li>
                    </ul>
    ...
    <div class="modal fade" tabindex="-1" role="dialog" id="mdlAplicacion">
        <div class="modal-dialog" role="document">
            <form action="{{url('/admin/sistema/aplicacion')}}" method="POST" id="frmAplicacion">
                <input type="hidden" name="_token" id="token" value="{{ csrf_token() }}">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        <h3 class="modal-title">
                            <i class="fa fa-cog fa-lg"></i>&nbsp; Crear Aplicación
                        </h3>
                    </div>
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    <label for="nombre">Ruta URL</label>
...
@section('js')
    {!! Html::script('js/modulos/administracion/sistema/aplicacion.js') !!}
@stop